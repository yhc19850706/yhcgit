...
import com.yhc.common.mapper.CommonCdMapper;
import com.yhc.common.model.CommonCd;
import com.yhc.weixin.bin.SetUp;
...
public class ContextUtil {
	...
	@Autowired
	private CommonCdMapper commonMapper;
	//初始化map缓存数据 
	...
	public void initCommonCode() throws Exception {
		...
		List<CommonCd> list = commonMapper.getAllCommonCode();
