...
public class User {
	...
	public String getRecomEmpId() {
		return recomEmpId;
	}

	public void setRecomEmpId(String recomEmpId) {
		this.recomEmpId = recomEmpId;
	}
	...
	public boolean isSigned() {
		signed = false;
		if(StringUtils.isNotEmpty(signinDts) && DateUtil.getCurDtStr().equals(signinDts.substring(0,8))){
			signed = true;
		}
		return signed;
	}
