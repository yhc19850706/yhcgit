...
//		System.out.println("123456后:" +m.getMD5("123456"));
...
//		System.out.println("abcdefghijk".substring(0,3));
//		System.out.println("abcdefghijk".substring(3,7));
//		System.out.println("abcdefghijk".substring(7,11));
